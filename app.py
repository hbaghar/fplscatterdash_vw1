...
for i in ['Assists', 'Bonus', 'BPS', 'Clean sheets', 'Creativity', 'Form', 'Goals Conceded', 'Goals Scored', 'ICT Index', 'Influence',
  ...
  input_list.append(
    dash.dependencies.Input(f'min_{j}','value')
  )
  input_list.append(
    dash.dependencies.Input(f'max_{j}','value')
  )
...
@app.callback(
    [dash.dependencies.Output('player_tbl', 'data'), dash.dependencies.Output('player_tbl', 'columns'), dash.dependencies.Output('TNameTxt', 'children'), dash.dependencies.Output('PosTxt', 'children')],
    [dash.dependencies.Input('player_tbl', "filter_query"), dash.dependencies.Input(f'TeamName','value'), dash.dependencies.Input(f'Position','value')] + input_list,
)
